...
export const parameterizationFormSlice = createSlice({
  name: 'parameterizationFormSlice',
  initialState: {
    parameterization: {
      id: 0,
      form_id: 0,
...
export const {
  ...
  nullLengths,
} = parameterizationFormSlice.actions;

export default parameterizationFormSlice.reducer;